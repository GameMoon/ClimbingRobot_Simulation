...
% PERIOD 1
[soln,tvec] = generateTrajectory("feet3",feetPositions(7+2,:),feetPositions(7+1,:)+[side_step 0 0],step_height, resolution,ik, weights,startState,mid_offset);
sim_states = [sim_states [tvec+toffset; soln]];
toffset = toffset + tvec(end) + resolution;

[soln,tvec] = generateTrajectory("feet4",feetPositions(10+2,:),feetPositions(10+1,:)+[side_step 0 0],step_height, resolution,ik, weights,soln(:,end),mid_offset);
sim_states = [sim_states [tvec+toffset; soln]];
toffset = toffset + tvec(end) + resolution;
...
[body3,tvec] = generateTrajectory("feet3",feetPositions(7+1,:)+[side_step 0 0], feetPositions(7,:),0, resolution,ik, weights,soln(:,end),-mid_offset);
[body4,tvec] = generateTrajectory("feet4",feetPositions(10+1,:)+[side_step 0 0],feetPositions(10,:),0, resolution,ik, weights,soln(:,end),-mid_offset);
...
[soln,tvec] = generateTrajectory("feet2",feetPositions(4+2,:),feetPositions(4+1,:)+[side_step 0 0],step_height, resolution,ik, weights,soln(:,end),mid_offset);
sim_states = [sim_states [tvec+toffset; soln]];
toffset = toffset + tvec(end) + resolution;

[soln,tvec] = generateTrajectory("feet1",feetPositions(1+2,:),feetPositions(1+1,:)+[side_step 0 0],step_height, resolution,ik, weights,soln(:,end),mid_offset);
sim_states = [sim_states [tvec+toffset; soln]];
toffset = toffset + tvec(end) + resolution;
...
% Body move
[body1,tvec] = generateTrajectory("feet1",feetPositions(1+1,:)+[side_step 0 0],feetPositions(1,:),0, resolution,ik, weights,soln(:,end),mid_offset);
[body2,tvec] = generateTrajectory("feet2",feetPositions(4+1,:)+[side_step 0 0],feetPositions(4,:),0, resolution,ik, weights,soln(:,end),mid_offset);
